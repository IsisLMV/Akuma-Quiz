...
public class Level {
    ...
    private void configurarNarrativa(String nomeFase) {
        if (nomeFase.equals("FASE 1")) {
            this.contexto = "Furiosa por ter perdido um concurso na TV, Tormenta quer mergulhar Paris em um inverno eterno de ignorância, congelando todo o progresso científico e tecnológico da cidade.";
            ...
            this.contexto = "O genial e competitivo Max transformou a cidade inteira em um videogame de arena gigante. Ele quer provar que a tecnologia pode dominar a humanidade e desafia você para um Quiz de Sobrevivência.";
            ...
            this.contexto = "Obcecado por mitologia, o Faraó quer reescrever a história e usar rituais antigos para sacrificar o futuro de Paris, trancando todos os direitos humanos e o conhecimento atual em hieróglifos indecifráveis.";
            ...
            this.fraseVitoria = "Uma vitória para os livros de história! Você decifrou os enigmas do Faraó e protegeu o desenvolvimento da humanidade!";
            ...
            this.contexto = "Cansado de ver seus akumas falharem, Hawk Moth sai das sombras e transforma o topo da Torre Eiffel em uma arena de batalha decisiva. Diante de toda Paris, ele ataca sua mente com ilusões e testes de conhecimento extremos para exaurir sua energia e reescrever a realidade.";
            ...
            this.fraseVitoria = "Miraculous Ladybug! Hawk Moth recuou da Torre Eiffel para as sombras. Sua inteligência salvou a ciência, a educação e o futuro da cidade. Os Miraculous estão seguros!";
            this.fraseDerrota = "As asas negras do akuma cobriram a Torre Eiffel e toda Paris... Hawk Moth venceu, apagando a sabedoria do mundo. Mas um verdadeiro herói sempre aprende com os erros e se levanta para lutar de novo!";
        }
    }
